...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/AppCenter/AppCenter-SDK-Apple/AppCenter.xcframework" "" "false" "macos-arm64_x86_64/AppCenter.framework"
  install_xcframework "${PODS_ROOT}/AppCenter/AppCenter-SDK-Apple/AppCenterCrashes.xcframework" "" "false" "macos-arm64_x86_64/AppCenterCrashes.framework"
fi
